...
if (!function_exists('blogarise_post_thumbnail_image')) :

    function blogarise_post_thumbnail_image()
    {
...
if (!function_exists('blogarise_post_title_content')) :

    function blogarise_post_title_content() { ?>
    ...
    <article class="small">
        ...
        <?php the_content(__('Read More','blogarise')); ?>
    </article> 
<?php }
endif;
