...
function blogarise_post_social_share_post($post) {

        $blogarise_blog_post_icon_enable = esc_attr(get_theme_mod('blogarise_blog_post_icon_enable','true'));
                if($blogarise_blog_post_icon_enable == true) {
        $post_link  = esc_url( get_the_permalink() );
        $post_title = get_the_title();
