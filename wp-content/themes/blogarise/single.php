            ...
            <div class="bs-blog-post single"> 
              <div class="bs-header">
                ...
                <?php } ?>
                    ...
                    if($blogarise_single_post_date == true){ ?>
                            ...
                            style="background-image: url('<?php echo esc_url($url); ?>');" <?php } ?>>
                                    ...
                                    <div class="inner">
                                      ...
                                      <div class="bs-blog-meta">
                                        <span class="bs-author"><?php if($blogarise_enable_single_post_admin_details == true){ ?> <a class="auth" href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"> <?php echo get_avatar( get_the_author_meta( 'ID') , 150); ?><?php the_author(); ?> </a>
                                            <?php } ?></span>
